...
<div id="wrapper">
	...
	<div class="home-block-area" >
	    	<div class="home-block-area zero">
		<?php print render($page['home_area_0']);?>
		</div>
	</div>
	...
	<div class="main_view">
		<div class="window">
                <div class="image_reel">
                    <a href="<?php print url('aboutus'); ?>"><img src="<?php print base_path() . drupal_get_path('theme', 'bluemasters') . '/images/slide-image-3.jpg'; ?>" width="600px" height="320px"></a>
                    <a href="<?php print url('ourservice'); ?>"><img src="<?php print base_path() . drupal_get_path('theme', 'bluemasters') . '/images/slide-image-2.jpg'; ?>" width="600px" height="320px"></a>
                    <a href="<?php print url('news'); ?>"><img src="<?php print base_path() . drupal_get_path('theme', 'bluemasters') . '/images/slide-image-1.jpg'; ?>" width="600px" height="320px"></a>
                </div>
                <div class="descriptions">
                    <div class="desc" style="display: none;">About Us</div>
                    <div class="desc" style="display: none;">Our Service</div>
